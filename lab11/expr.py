# expr.py contains our interpreter's representation of expressions and values.
# The subclasses of Expr and Value encapsulate all the types of expressions and values in the PyCombinator language.
# The global environment, a dictionary containing the bindings for primitive functions, is also defined at the bottom of this file.
