...
def make_glookup(class_assignments):
    ...
    """
    "*** YOUR CODE HERE ***"
    current_point, current_total = 0, 0

    def glookup(key, point):
        nonlocal current_point, current_total
        current_total += class_assignments[key]
        current_point += point
        return current_point / current_total
